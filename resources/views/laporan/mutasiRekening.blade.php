...
<head>
    ...
    <title>Mutasi Rekening - Dashboard Admin</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="table-container">
            <div class="table-header">Daftar Mutasi Rekening</div>
            <table class="data-table">
                ...
                <tbody>
                    <tr>
                        <td colspan="6" class="no-data">Belum ada data mutasi rekening</td>
                    </tr>
                </tbody>
            </table>
        </div>
